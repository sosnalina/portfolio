(function () {
  ...
  // Two equal-length panels — a starting point, matching Gallery 2's
  // own "pick a reasonable value and report it" precedent. Must match
  ...
  // 1's and Gallery 2's own boundaries/parent-JS pairs.
